...
all_views = filtered_views_by_type(doc, view_types_list())
# Filter Views By Parameter
all_views = filter_views_by_parameter_and_value(all_views, "BIMPL_ROLA", sheets_role)
all_views = sub_elements_from_list(all_views, 1)
all_views = filter_views_by_parameter_and_value(all_views, "BIMPL_FAZA", sheets_phase)
all_views_index = sub_elements_from_list(all_views, 0)
all_views = sub_elements_from_list(all_views, 1)
...
output = create_sheets_from_list(all_views, sheets_number_list, sheets_name_list, parameters_views_list, par_name_lLst)
